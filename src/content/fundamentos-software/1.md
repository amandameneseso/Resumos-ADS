...
#### 1.1.1 Software de sistema (básico)
...
![image.png](https://files.passeidireto.com/cc7c4141-4c2d-4115-aa5b-d0170ea61658/bga.png)
...
![image.png](https://programadorcasual.com/wp-content/uploads/2020/08/sistema-operacional.png)
...
<!-- >💡 **Para saber mais:**
>
>[A história de como ensinamos máquinas a pensar](https://www.notion.so/A-hist-ria-de-como-ensinamos-m-quinas-a-pensar-220214c5630e80118608e5e2dfbb0419?pvs=21) -->
...
- **Versionamento**: Atribuição de um **número de versão ao estado do projeto**, criando versões à medida que o desenvolvimento avança.
...
### 5.1 Metodologia Tradicional (Modelo Cascata)
...
![image.png](https://miro.medium.com/0*4bUjFAIrbKrjnghb)

![image.png](/images/divider61.png)
